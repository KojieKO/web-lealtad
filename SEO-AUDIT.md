...
| SEO-JS-01 | Alto | La agenda principal solo aparecía después de ejecutar JavaScript. | El contenido ya es rastreable en el HTML inicial y continúa actualizándose desde `agenda.md`. | Corregido |
...
| SEO-DATA-01 | Alto | `agenda.md` mezcla actos de 2027 con fechas de febrero, marzo y mayo de 2026; una fila muestra día 13 pero declara del 4 al 12. | Impide publicar datos `Event` fiables y puede mostrar fechas incoherentes a usuarios y Google. | Pendiente de confirmación |
